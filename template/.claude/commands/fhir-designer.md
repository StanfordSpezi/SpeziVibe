...
**All output is in chat.** At the end, tell the developer: *"Save this document as `docs/fhir-data-model.md` in your project. Other agents (like `/fhir-mapping`) can read it as context for implementation."*
...
> Generated by `/fhir-designer`. Save as `docs/fhir-data-model.md`.
> Use this document as context when running `/fhir-mapping`, `/fhir`, or any agent that implements data storage or API calls.
